...
<body>
    ...
    try{
        ...
        $sentencia = "UPDATE catedra SET baja = 0 WHERE cod_catedra='$cod_catedra'";
        if (!mysqli_query($link, $sentencia)){
            throw new Exception();
        }
        echo '<script>window.location.replace("exito.php?mensaje=La cátedra fue reestablecida correctamente -");</script>';
    }
    catch(Exception $e){
